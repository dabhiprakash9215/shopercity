                                            ...
                                            ?>
                                                <a href="user/index.php"
                                                    class="btn btn-rounded btn-blue btn-block btn-gradient d-flex align-items-center justify-content-center">Add your business</a><?php
                                                                                                                                                                                    ...
                                                                                                                                                                                    ?>
                                                    <a href="payment/pay.php" id="<?php if (isset($_SESSION) && isset($_SESSION['user_id']) && !empty($_SESSION['user_id'])) {
                                                                                                                                                                                            echo "PayNow";
                                                                                                                                                                                        } ?>" class="btn btn-rounded btn-blue btn-block btn-gradient d-flex align-items-center justify-content-center">Buy Now...</a>
                                                <?php
                                                                                                                                                                                    } else {
                                                ?>
