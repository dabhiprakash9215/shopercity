					...
					<form class="row g-3" method="post" action="" enctype='multipart/form-data' id="add_vendor">
						...
						<div class="col-12 row">
							<div class="col-12 col-md-12 col-lg-6">
								...
								<input type="text" class="form-control form-control-lg" name="fb_link" value="<?php if (!empty($vendor_row['fb_link'])) {
							...
							<div class="col-12 col-md-12 col-lg-6">
								...
								<input type="text" class="form-control form-control-lg" name="insta_link" value="<?php if (!empty($vendor_row['insta_link'])) {
