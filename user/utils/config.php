...
define("MERCHANTIDLIVE", "M227HO5UUFOLJ_25072");
...
define("SALTINDEX", "1");
define("REDIRECTURL", "notification/success.php");
define("SUCCESSURL", "notification/success.php");
define("FAILUREURL", "notification/failed.php");
