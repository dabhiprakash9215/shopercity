              ...
              <form method="post" action="query.php">
                <div class="card-body">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" name="name" placeholder="Enter state Name" value="<?php echo $name; ?>">
					  </div>
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-primary" name="state" value="<?php echo $button; ?>"><?php echo $button; ?></button>
                </div>
              </form>
            </div>
            <!-- /.card -->
